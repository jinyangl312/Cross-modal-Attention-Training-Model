function [ motion_energy, left_Total, right_Total ] = VisualStimAnalyser( stim )
% Calculate the visual motion energy of an image

    % Original code from George Mather, University of Sussex, UK, 2010.
    %--------------------------------------------------------------------------
