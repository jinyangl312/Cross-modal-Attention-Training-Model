function [ motion_energy, left_Total, right_Total ] = AudioStimAnalyser( stim )
% Calculate the auditory motion energy of an auditory input.

    % Adapted from the function VisualStimAnalyser:
    % Step 1a: Define the space axis of the filters
    nx=40;              %Number of spatial samples in the filter
    max_x =1.0;         %Half-width of filter (deg)
